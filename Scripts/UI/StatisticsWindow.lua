statisticsWindow = class(Turbine.UI.Lotro.GoldWindow);

-- Constructor
function statisticsWindow:Constructor()
...
-- Set Visibility
function statisticsWindow:SetVisibility(state)
...
-- Set position
function statisticsWindow:SetWindowPosition(x, y)
...
WordGuesser.UI.statisticsWindow = statisticsWindow();